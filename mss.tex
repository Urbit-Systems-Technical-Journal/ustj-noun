...
\begin{abstract}
Noun serialization is commonly used for Nock communication, both between instances like Urbit ships and with the runtime and the Unix host operating system.  This article describes the principal convention for representing a noun in compressed form as a byte array, as well as introduces variant encodings for educational purposes.
\end{abstract}

\renewcommand{\thefootnote}{\fnsymbol{footnote}}
\setcounter{footnote}{0}
\footnotetext[1]{\sloppy We gratefully acknowledge the original architect of \texttt{+jam} and \texttt{+cue}, \mbox{Curtis} Yarvin \patp{sorreg-namtyv}.  The original function, in \href{https://github.com/cgyarvin/urbit/blame/55f591594080d276fc446ceafa4afff092561613/watt/jam.watt}{\texttt{jam.watt}}, dates to \textasciitilde 2011.6.11.}
...
\begin{tabular}{ l l r }
  ...
  \texttt{0x1234} & 15 & \texttt{0b100001100100001} \\
  & & \texttt{↳1000000000000000} \\
\end{tabular}
\end{table}
...
\begin{tabular}{ l l r }
  ...
  \texttt{0x1234} & 15 & \texttt{0b\textcolor{lightgray}{10000}1100100001} \\
  & & \texttt{↳1000000000000000} \\
\end{tabular}
\end{table}
